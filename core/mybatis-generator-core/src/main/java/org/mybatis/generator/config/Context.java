...
public class Context extends PropertyHolder {
    ...
    public void generateFiles(ProgressCallback callback,
                              ...
                              List<GeneratedXmlFile> generatedXmlFiles, List<ResourceGeneratedFile> generatedResourcesFiles, List<String> warnings)
            throws InterruptedException {
        ...
        generatedResourcesFiles.addAll(pluginAggregator.contextGenerateAdditionalResourceFiles());
    }
